...
#Use the ciscoconfparse library to find the crypto maps that are NOT using 'aes'
...
def main():
    ...
    crypto = cisco_file.find_objects_wo_child(parentspec=r'crypto map CRYPTO', childspec=r'AES')
